      ...
      <div className="relative z-10 mx-auto w-full max-w-[1500px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mx-auto mb-14 max-w-4xl text-center sm:mb-16 lg:mb-20">
          ...
          <motion.p
            ...
            "
          >
            From contemporary living spaces to refined bedrooms, dining areas,
            offices, and luxury commercial environments, every interior is
            carefully planned to balance beauty, comfort, functionality, and
            lasting character.
          </motion.p>
        </div>

        {/* Interior media gallery */}
        <InteriorGrid />
      </div>
    </section>
  );
