...
import TvConsoleGrid from "./TvConsoleGrid";

export default function TvConsoleSection() {
  return (
    <section
      id="tv-console"
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1500px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mx-auto mb-14 max-w-4xl text-center sm:mb-16 lg:mb-20">
          ...
          <motion.p
            ...
            "
          >
            Explore beautifully crafted TV console designs that bring together
            modern storage, elegant wall finishes, lighting, display features,
            and carefully planned entertainment systems. Every installation is
            created to enhance the room while keeping the space refined,
            functional, and visually balanced.
          </motion.p>
        </div>

        {/* TV console media gallery */}
        <TvConsoleGrid />
      </div>
    </section>
  );
