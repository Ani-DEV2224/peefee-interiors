      ...
      <div className="relative z-10 mx-auto w-full max-w-[1500px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mx-auto mb-14 max-w-4xl text-center sm:mb-16 lg:mb-20">
          ...
          <motion.h2
            ...
            "
          >
            Striking Exteriors That Create
          ...
          <motion.p
            ...
            "
          >
            From contemporary building façades and entrance designs to
            outdoor living spaces, landscaping, lighting, and finishing
            details, we create exterior environments that combine
            architectural beauty, durability, functionality, and timeless
            visual appeal.
          </motion.p>
        </div>

        {/* Exterior media gallery */}
        <ExteriorGrid />
      </div>
    </section>
  );
